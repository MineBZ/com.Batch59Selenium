...
public class C04_RelativeXpath {
    public static void main(String[] args) {
       // https://www.diemol.com/selenium-4-demo/relative-locators-demo.html#
        ...
        WebElement bostonWE=driver.findElement(By.id("pid6_price"));
        WebElement sailorWE=driver.findElement(By.id("pid11_price"));
        WebElement mountieWE=driver.findElement(RelativeLocator.with(By.tagName("img"))
